...
class LineSegment(Entity):
    ...
    def __init__(self, entitys, screen, position, pix_per_unit, line_start, line_end, color = (0,0,0)):
        ...
        self.start_dot = Dot(self.subentitys, screen, [0,0], 2, color)
        self.end_dot = Dot(self.subentitys, screen, [0,0], 2, color)
    ...
    def set_line_pos(self, line_start, line_end):
        ...
        self.start_dot.set_text(line_start)
        self.end_dot.set_position(screen_line_end)
        self.end_dot.set_text(line_end)
